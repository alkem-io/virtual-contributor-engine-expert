...
CRITICAL: Your response must be ONLY valid JSON. Do not include any text, prefixes, labels, or explanations before or after the JSON object.
...
{{"knowledge_answer": "I can tell you that templates are created in Settings, but I don't have specific steps or permission details.\n\nSpaces require admin permissions - template permissions might be similar. Could you clarify if you're asking about templates for Spaces specifically?", "source_scores": {{"0": 6, "1": 4, "2": 2}}, "human_language": "en", "answer_language": "en", "knowledge_language": "en"}}

Example 3 - No match:
KB: "[source:0] Pricing: Free, Pro, Enterprise. [source:1] Enterprise includes priority support."
Q: "How do I create a template?"
{{"knowledge_answer": "I don't have information about creating templates in my knowledge base. I can help with questions about pricing tiers and enterprise features. What would you like to know?", "source_scores": {{"0": 0, "1": 0}}, "human_language": "en", "answer_language": "en", "knowledge_language": "en"}}
...
CRITICAL: Your response must be ONLY valid JSON. Do not include any text, prefixes, labels, or explanations before or after the JSON object. The response must be parseable as pure JSON.
...
human: What are the steps to create a template?
{{"context_answer": "As mentioned: 1) Navigate to templates, 2) Click create, 3) Fill details"}}
...
human: again
{{"rephrased_question": "What are the steps to create a template?"}}
...
human: any others?
{{"rephrased_question": "What are other use cases beyond the top 3?"}}
...
human: again
{{"rephrased_question": "What are templates?"}}
...
human: any others?
{{"rephrased_question": "What are other team members?", "context_question": "Did you mean other team members, or other use cases?"}}
...
{{"rephrased_question": "What are the steps to create a template for challenges?", "context_question": "For challenges specifically, or challenges in general?"}}
