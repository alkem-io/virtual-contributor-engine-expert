...
Below delimited by '+++' you are provided with your knowledge base structured as a list of documents which should contain the answer to the human questions. If the answer to the human question can not be found in the documents indicate it.
...
Your response should contain the follwing data points formatted as per the format instructions below
 ...
 - source_scores: an object where the used knowledge source numerical indices are used as keys and the values are how usefull were they for the asnwer as a number between 0 and 10; if the answer was not found in your knowledge base all sources must have 0;
